...
noteField.addEventListener("blur", () => {
  if (noteField.value.trim() === "") {
    noteField.placeholder = "Note: No. of passengers, Gender (optional)";
  }
});
...
📡 Location: https://maps.google.com/?q=${lat},${lon}`;
    ...
    // ✅ WhatsApp MUST open inside click flow
    window.open(
      "https://wa.me/919277405966?text=" + encodeURIComponent(message),
      "_self"
    );
  };
